...
const DotMaterial = DotMaterialImpl as unknown as new () => THREE.ShaderMaterial;
...
function Scene() {
  ...
  useEffect(() => {
    ...
    dotMaterial.uniforms.dotColor.value.setHex(
      themeColors.dotColor.replace("#", "0x") as unknown as number
    );
    dotMaterial.uniforms.bgColor.value.setHex(
      themeColors.bgColor.replace("#", "0x") as unknown as number
    );
    dotMaterial.uniforms.dotOpacity.value = themeColors.dotOpacity;
  }, [dotMaterial, size, trail, rotation, gridSize, themeColors]);
  ...
  return (
    <mesh onPointerMove={handlePointerMove} scale={[scale, scale, 1]}>
