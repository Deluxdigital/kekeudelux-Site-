    ...
    >
      <div className="w-full flex items-center justify-center">
        <div className="container mx-auto flex items-center justify-center">
          {/* bloco central com degradê estático, sem efeitos animados */}
          <div className="relative w-full max-w-5xl rounded-[3rem] border border-border/40 bg-gradient-to-r from-neon-purple via-neon-blue to-neon-cyan/80 shadow-[0_0_60px_hsl(var(--neon-blue)/0.5)] overflow-hidden">
